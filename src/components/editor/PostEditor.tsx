...
import { CropGuideThumbnail } from "./CropGuideThumbnail";
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex w-full flex-col border-r border-border bg-white md:w-[420px] shrink-0">
          ...
          <div className="flex-1 overflow-auto p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              {platforms.map((p) => {
                ...
                return (
                  ...
                  >
                    <span className="capitalize font-medium">{p === "x" ? "X" : p === "youtube" ? "YouTube" : p}</span>
            ...
            {/* Media preview thumbnails — format-aware with safe-area + crop guides */}
            {mediaFiles.length > 0 && (
                ...
                {mediaFiles.map((media) => {
                  ...
                  return (
                    <div key={media.id} className="group relative">
                      {noPreview ? (
                        <div className="flex aspect-square w-full items-center justify-center flex-col gap-1 rounded-lg border border-border bg-muted p-2">
                      ...
                      {isUploading && (
                        <div className="absolute inset-x-0 bottom-0 rounded-b-lg bg-background/85 p-1.5">
                      ...
                      <button
                        ...
                        className="absolute right-1.5 top-1.5 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-foreground/70 text-background opacity-0 transition-opacity group-hover:opacity-100 active:scale-95"
                        title="Remove"
                      >
