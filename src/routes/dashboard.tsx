...
import { Plus, Trash2, FileText, Clock, Sparkles, Image as ImageIcon, PenLine, Eye, Video, Zap, Calendar, History as HistoryIcon } from "lucide-react";
      ...
      <div className="mx-auto max-w-3xl px-6 py-10 space-y-10">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-foreground">Live feed preview</p>
              <p className="text-xs text-muted-foreground">See it inside a real app</p>
            </div>
          </Link>
          <Link
            to="/automation"
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Auto-DM on Instagram</p>
            </div>
          </Link>
          <Link
            to="/schedule"
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-foreground">Schedule content</p>
              <p className="text-xs text-muted-foreground">Generate & autopost</p>
            </div>
          </Link>
          <Link
            to="/history"
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-foreground">Draft history</p>
              <p className="text-xs text-muted-foreground">All your drafts</p>
            </div>
          </Link>
        </section>
